...
public class LinkServiceTest {
    ...
    void shouldReturnListOfLinkResponsesWhenUserHasLinks() {
        // Arrange
        when(linkRepository.findByUserIdOrderByCreatedAtAsc(user.getId())).thenReturn(List.of(link1, link2));
        ...
        verify(linkRepository).findByUserIdOrderByCreatedAtAsc(user.getId());
    }
    ...
    void shouldDeleteAllLinksForGivenUser() {
        ...
        when(linkRepository.findByUserIdOrderByCreatedAtAsc(user.getId())).thenReturn(linkList);
    ...
    void shouldReturnSilentlyWhenNoLinksToDelete() {
        // Arrange
        when(linkRepository.findByUserIdOrderByCreatedAtAsc(user.getId())).thenReturn(List.of());
